...
import { IPWeb3Provider, IStateUser, StateWeb3 } from './types'

const Web3Context = createContext()

export const Web3Provider = (props: IPWeb3Provider) => {
  let provider: any
  ...
  function setChain(chainId: number) {
    setState('chain', (newState) => {
      ...
      !isSupported &&
        console.warn(
          `${BLOCKCHAINS_RECORD[currentBlockchainId].name} is not supported. Please switch to Fantom Network to use Tombheads escrow.`,
        )
      return {
        ...newState,
        isSupported,
